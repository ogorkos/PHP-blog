        ...
        <div class="row">
            <div class="form-group col-md-6">  
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="text" class="form-control myinput" name="author" value="<?php echo $post_author ?>" />
                </div>
            ...
            <div class="col-md-6 p-3">
                <img height="190" src="../images/<?php echo $post_image; ?>" alt="">
            </div>      
        </div>
        <div class="form-group mt-3">
            <label class="edit_label">Post Content</label>
            <textarea class="form-control myinput" name="post_content" rows="5" cols="25"><?php  echo $post_content ?>
            </textarea>
        </div>
